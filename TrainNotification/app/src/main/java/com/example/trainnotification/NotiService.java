...
public class NotiService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (intent == null) {
            if (thread == null) {
                thread = new ConnectThread(server_ip);
                thread.start();
            }
    ...
    private void notificationSetting() {
        ...
        SharedPreferences pref = getSharedPreferences("eNotification Setting Fil", MODE_PRIVATE);
    ...
    public void createNotification(String location, String datetime, Bitmap bm, String image_name) {
        Log.e("NotiService", "알림 생성 시작!");
        ...
        // 헤드업 알림을 위한 인텐트
        Intent fullScreenIntent = new Intent(this, NotificationDetailActivity.class);
        fullScreenIntent.putExtra("location", location);
        fullScreenIntent.putExtra("datetime", datetime);
        ...
        builder.setContentText("[" + datetime + "] " + location);
        ...
        Log.e("NotiService", "알림 생성 끝!");
        // 받은 알림 데이터 저장
        sendNotificationDataToDB(datetime, location, image_name, false);
        Log.e("NotiService", "알림 파베 업로드 끝!");
    }
...
//                sthread.start();
                ...
                try {
                    ...
                    int count = 0;
                    Byte[] isDataReceived = new Byte[100];
                    while (isReceiving) {
